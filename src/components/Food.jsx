            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                ...
                <div>
                    ...
                    <div className='flex justify-between max-w-[390px] w-full'>
                        ...
                        <button onClick={()=> filterPrice('$30')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
                            $30
                        </button>
                        <button onClick={()=> filterPrice('$40')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
                            $40
                        </button>
                    </div>
                </div>
                ...
                {foods.map((item, index) => (
                    <div key={index} className='border shadow-lg rounded-lg hover:scale-105 duration-300'>
                        ...
                        <div className='flex justify-between px-2 py-4'>
                            ...
                            <p>
                                <span className='bg-orange-500 text-white font-bold py-2 px-1.5 rounded-full'>
                                    {item.price}
                                </span>
                            </p>
                        </div>
